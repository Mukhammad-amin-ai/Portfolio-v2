...
const ProjectCard = forwardRef<HTMLDivElement, ProjectCardProps>(
  ({ index, source, muxid, type, name, link, blurDataUrl }, ref) => {
    return (
      <div ref={ref} className="@container" data-index={index}>
        ...
        >
          <div className="relative mt-5 flex aspect-square items-center justify-center overflow-clip rounded-md bg-[var(--color-secondary-300)] p-[var(--space-md)] sm:p-[var(--space-lg)] xl:p-[var(--space-2xl)]">
            <Image
