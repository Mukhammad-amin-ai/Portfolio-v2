    ...
    <section className="mb-[-100svh] py-0 " id="containerHero">
      ...
      >
        <div
          ref={heroRef}
          id={"hero"}
          className="relative flex w-full flex-col md:gap-y-(--space-lg)"
        >
          <h1 className="text-[clamp(3rem,1.200rem+10.000vw,10rem)] xl:text-(length:--text-heading-display) font-medium overflow-clip">
            <CharReveal
              className="w-full hidden h-full lg:block"
              text="MUKHAMMADAMIN"
              delay={0}
            />
            <span className="flex flex-col text-(length:--text-heading-display) font-medium uppercase leading-[80%] tracking-(--tracking-heading) text-(--color-secondary-400) lg:hidden">
              <CharReveal text="MUKHAMMAD" delay={0} />
              <CharReveal text="AMIN" delay={0.3} />
            </span>
          </h1>

          <div className="relative grid w-full grid-cols-12 justify-between gap-x-(--gap-fluid) gap-y-(--space-md)">
            <div className="col-span-12 flex flex-col justify-between gap-y-(--space-2xl) pt-(--space-sm) md:col-span-4 md:gap-y-(--space-md)">
              <div className="grid-gap flex flex-col gap-(--space-md) md:gap-y-(--space-xl)">
                ...
                <div className="flex flex-col gap-y-(--space-sm) md:gap-y-(--space-md)">
                  <div className="w-full max-w-[32ch] text-balance text-(length:--text-base) font-medium leading-snug text-(--color-secondary-100) xl:text-(length:--text-base-large) 3xl:text-[length:var(--text-heading-body)]">
                    <TextReveal
            ...
            <div className="inset-e-1 col-span-8 flex w-full flex-col items-end justify-end md:col-span-4">
              <div className="overflow-clip">
                <span className="block max-w-[15ch] text-right font-mono text-(length:--text-base-small) font-medium uppercase leading-snug tracking-(--tracking-mono) text-[--color-secondary-100] md:max-w-max 3xl:text-[length:var(--text-base)]">
                  <TextReveal
              ...
              <div className="overflow-clip">
                <span className="block text-(length:--text-heading-2) font-semibold uppercase leading-none tracking-(--tracking-heading) text-(--color-secondary-300) sm:text-(length:--text-heading-1--alt) 3xl:text-[length:var(--text-heading-1)]">
                  <TextReveal
                    text={available()}
                    delay={1.3}
                    delayperwords={0.01}
