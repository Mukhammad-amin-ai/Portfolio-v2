      ...
      >
        <div className="relative flex w-full flex-col md:gap-y-[var(--space-lg)]">
          <h1 className="text-[length:var(--text-h1)] overflow-clip">
            ...
            >
              <path
                d="M0.169983 160V138.53L89.44 15.586V24.852H0.169983V0.669983H117.238V21.914L27.742 144.858V135.818H120.176V160H0.169983Z"
                fill="currentColor"
                style={{
                  transform: "none",
              ...
              />
              <path
                d="M289.819 160V0.669983H311.741L404.175 120.224H398.299V0.669983H425.419V160H403.497L311.289 40.446H316.939V160H289.819Z"
                fill="currentColor"
                style={{
                  transform: "none",
                  transformOrigin: "50% 50%",
              ...
              />
              <path
                d="M449.123 160V0.669983H556.473V23.496H477.147V67.566H551.275V90.618H477.147V136.948H556.473V160H449.123Z"
                fill="currentColor"
                style={{
                  transform: "none",
                  transformOrigin: "50% 50%",
              ...
              />
              <path
                d="M766.169 160L838.263 0.669983H862.671L935.669 160H906.063L886.627 115.252L898.379 123.162H802.781L814.985 115.252L795.549 160H766.169ZM850.241 31.858L818.375 107.342L812.499 100.336H888.435L883.689 107.342L851.145 31.858H850.241Z"
                fill="currentColor"
                style={{
                  transform: "none",
                  transformOrigin: "50% 50%",
              ...
              />
              <path
                d="M924.369 160L996.463 0.669983H1020.87L1093.87 160H1064.26L1044.83 115.252L1056.58 123.162H960.981L973.185 115.252L953.749 160H924.369ZM1008.44 31.858L976.575 107.342L970.699 100.336H1046.63L1041.89 107.342L1009.34 31.858H1008.44Z"
                fill="currentColor"
                style={{
                  transform: "none",
                  transformOrigin: "50% 50%",
              ...
              />
              <path
                d="M1100.2 160V0.669983H1129.35V135.366H1204.38V160H1100.2Z"
                fill="currentColor"
                style={{
                  transform: "none",
                  transformOrigin: "50% 50%",
              ...
              />
              <path
                d="M1215.36 160V0.669983H1244.51V160H1215.36Z"
                fill="currentColor"
                style={{
                  transform: "none",
                  transformOrigin: "50% 50%",
              ...
              />
              <path
                d="M1268.51 160V0.669983H1294.05L1352.58 132.428H1345.58L1404.11 0.669983H1429.42V160H1402.98V41.802H1411.12L1357.55 160H1340.15L1286.59 41.802H1294.95V160H1268.51Z"
                fill="currentColor"
                style={{
                  transform: "none",
                  transformOrigin: "50% 50%",
